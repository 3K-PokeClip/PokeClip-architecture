...
export const DIAGRAMS: DiagramMeta[] = [
  ...
  { num: 1, title: 'IA · 정보 구조', en: 'Information Architecture', file: '1_Pokeclip_IA.html', width: 2280, height: null },
  ...
  { num: 5, title: '클라우드 아키텍처 · AWS', en: 'Cloud Architecture', file: '5_Pokeclip_CA.html', width: 2700, height: 1760 },
]
